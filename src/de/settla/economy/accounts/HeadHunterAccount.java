...
@Serial("HeadHunterAccount")
public class HeadHunterAccount extends Account<UUID> implements UnlimitedAccount {

	public HeadHunterAccount(UUID id, long minimumBalance, long maximumBalance) {
		super(id, minimumBalance, maximumBalance);
		// TODO Auto-generated constructor stub
	}

	public HeadHunterAccount(Map<String, Object> map) {
