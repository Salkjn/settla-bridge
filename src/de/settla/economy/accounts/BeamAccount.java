...
@Serial("BeamAccount")
public class BeamAccount extends Account<UUID> {

	public BeamAccount(UUID id, long minimumBalance, long maximumBalance) {
		super(id, minimumBalance, maximumBalance);
	}

	public BeamAccount(Map<String, Object> map) {
