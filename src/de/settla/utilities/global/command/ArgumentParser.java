...
public class ArgumentParser {
	...
	private String[] args;
	private net.md_5.bungee.api.plugin.Command command;
	...
	public ArgumentParser(String[] args, net.md_5.bungee.api.plugin.Command command, CommandSender sender) {
		this(args);
	...
	public String get(int index){
		return index <= args.length ? args[index-1] : null;
	}
	...
	public Double getDouble(int index, String errorMessage) {
		return getDouble(index, sender -> new TextBuilder().text(errorMessage).send(sender));
	}
	...
	public Long getLong(int index, String errorMessage) {
		return getLong(index, sender -> new TextBuilder().text(errorMessage).send(sender));
	}
	...
	public Integer getInt(int index, String errorMessage) {
		return getInt(index, sender -> new TextBuilder().text(errorMessage).send(sender));
	}
	...
	public Boolean getBoolean(int index, String errorMessage) {
		return getBoolean(index, sender -> new TextBuilder().text(errorMessage).send(sender));
	}
