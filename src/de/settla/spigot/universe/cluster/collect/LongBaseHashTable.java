package de.settla.spigot.universe.cluster.collect;
...
/*
 * This code comes from sk89q and other contributors, please check their terms:
 *
 *
...
public class LongBaseHashTable extends LongHash {
    ...
    public synchronized List<EntryBase> entries() {
        List<EntryBase> ret = new ArrayList<EntryBase>();
