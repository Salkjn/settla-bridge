...
public class Ref {
	...
	public static class NBT {
		...
		public static final Class<?> CLASS_NBT_TAG_BASE = getNMS("NBTBase"),
				CLASS_NBT_TAG_COMPOUND = getNMS("NBTTagCompound"), CLASS_NBT_LIST = getNMS("NBTTagList"),
				CLASS_INTEGER_ARRAY = new int[] {}.getClass(), CLASS_BYTE_ARRAY = new int[] {}.getClass(),
				CLASS_CRAFT_ITEM_STACK = getOBC("inventory.CraftItemStack"), CLASS_NMS_ITEM_STACK = getNMS("ItemStack");
		...
		private static final Method AS_BUKKIT_COPY_METHOD = getMethod(CLASS_CRAFT_ITEM_STACK, "asBukkitCopy",
				CLASS_NMS_ITEM_STACK);
		...
		private static final Method SET_INT_METHOD = getMethod(CLASS_NBT_TAG_COMPOUND, "setInt", String.class,
				Integer.TYPE);
		...
		private static final Method SET_BOOLEAN_METHOD = getMethod(CLASS_NBT_TAG_COMPOUND, "setBoolean", String.class,
				Boolean.TYPE);
		...
		private static final Method SET_DOUBLE_METHOD = getMethod(CLASS_NBT_TAG_COMPOUND, "setDouble", String.class,
				Double.TYPE);
		...
		private static final Method SET_LONG_METHOD = getMethod(CLASS_NBT_TAG_COMPOUND, "setLong", String.class,
				Double.TYPE);
